...
const SearchBar = ({ onClose }) => {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto">
      <div className="flex flex-col lg:flex-row bg-white border border-gray-300 rounded-lg lg:rounded-full shadow-lg overflow-hidden">
        {/* Destination */}
        <div className="flex-3 p-4 lg:p-3">
